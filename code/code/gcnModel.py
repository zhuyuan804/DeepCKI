...
class Model(object):
    ...
    def build(self):
        ...
        with tf.compat.v1.variable_scope(self.name):
            self._build()
        variables = tf.compat.v1.get_collection(tf.compat.v1.global_variables, scope=self.name) #原tf.GraphKeys.GLOBAL_VARIABLES
...
class GCNModelVAE(Model):
    ...
    def _build(self):
        ...
        self.reconstructions = InnerProductDecoder(input_dim=self.hidden2_dim,act=lambda x: x,
